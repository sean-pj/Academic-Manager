"""
Django settings for academic_manager project.
...
SECRET_KEY = 'django-insecure-5^-+5af#x7+7!((ky59b5q=8%)7g2i54q6wyzb)rvtdt=18akd'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR, "submissions/templates")
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'academic_manager.wsgi.application'
